...
import cl from './heartIcon.module.css'


export const HeartIcon: FC = () => {
    return (
        <div className={cl.wrapper}>
            <svg className={cl.heartIcon} xmlns="http://www.w3.org/2000/svg"viewBox="0 0 23 20" fill="none">
            ...
            <div className={cl.itemCount}>2</div>
        </div>
